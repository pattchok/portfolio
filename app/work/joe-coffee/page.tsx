...
export const metadata: Metadata = {
  title: "Joe Coffee Mobile Ordering - Patt",
};
...
export default function JoeCoffeePage() {
  return (
      ...
      <section className="relative overflow-hidden pt-28 pb-16 px-6 md:px-10 lg:px-16">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <FadeIn delay={0.16}>
            ...
            >
              Mobile ordering experience for a beloved specialty coffee brand,
              bringing the in-store warmth to a digital-first product.
            </p>
          </FadeIn>
